...
for city, city_data in cities.items():
    ...
    dates = pd.date_range('2023-05-22', '2025-04-30')
    for date in dates:
...
for city, city_data in cities.items():
    ...
    for month_start, month_end in zip(pd.date_range('2023-01', '2025-05', freq='MS'), pd.date_range('2023-01', '2025-05', freq='ME')):
...
x_data = [date.date().isoformat() for date in pd.date_range('2023-01', '2025-05', freq='D')]
y_max = 0
