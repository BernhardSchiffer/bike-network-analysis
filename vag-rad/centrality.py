...
@nx._dispatchable
@py_random_state(4)
def spatial_betweenness_centrality(G, w_orig, w_dest, k=None, normalized=True, weight=None, seed=None):
    if k is not None:
...
bbox = [49.443729, 11.056988, 49.450753, 11.071107]
...
graph = ox.graph_from_bbox(bbox, simplify=False, retain_all=True, custom_filter=[bikeable_ways, bikeable_areas, bikeable_footpaths])

graph
# %%
spatial_betweenness_centrality(graph, weight='length')
# %%
